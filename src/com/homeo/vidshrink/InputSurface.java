/*
 * EGL wrapper around the video encoder's input Surface.
 * Adapted from the Android CTS ExtractDecodeEditEncodeMux sample (Apache 2.0).
 * Holds an EGL context/surface so the decoder's frames can be drawn into the
 * encoder's input Surface via OpenGL.
 */
